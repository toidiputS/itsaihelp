...
const Home: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    if (metaDesc) {
      metaDesc.setAttribute('content', 'Bet You have never made a single penny online. Make your first $1 on your way to $5k within the ItsAI Ecosystem with our AI Assistants you keep on your homescreen and much more.'); 
    }
  }, []);
