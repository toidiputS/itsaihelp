 ...
 *  - Make sure the PDF lives at: /public/downloads/ItsAI_Help_Pack1.pdf
 */

const Pack1: React.FC = () => {
            ...
            <section className="bg-slate-900/60 border border-slate-800 rounded-2xl p-6 mb-10">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        ...
                        <p className="text-3xl font-semibold text-slate-50">$39</p>
